...
/** \brief MAC net event task is invalid. */
#define ER_CODE_MAC_NET_TASK_INVALID           	 (0x2601)
...
/** \brief FTP Server task invalid */
#define ER_CODE_FTP_TASK_INVALID				 (0x3300)
/** \brief RTC Initilization failed */
#define ER_CODE_RTC_INIT_FAILED					 (0x3400)
/** \brief RTC Initilization failed */
#define ER_CODE_RTC_SET_CLOCK_FAILED			 (0x3401)		
