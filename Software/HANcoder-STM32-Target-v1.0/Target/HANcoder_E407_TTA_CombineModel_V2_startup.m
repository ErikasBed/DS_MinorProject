...
MasterID = Simulink.Parameter; % Define as parameter
MasterID.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
MasterID.Value = 1; % Initial value is set to one
