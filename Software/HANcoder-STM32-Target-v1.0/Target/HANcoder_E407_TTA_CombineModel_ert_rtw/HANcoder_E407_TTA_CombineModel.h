...
typedef struct {
  ...
  uint8_T DataStoreRead2_l;            /* '<S106>/Data Store Read2' */
  uint8_T Add_jr;                      /* '<S172>/Add' */
  uint8_T Cast_o;                      /* '<S173>/Cast' */
  uint8_T Cast1_nt;                    /* '<S173>/Cast1' */
  uint8_T Cast_j;                      /* '<S174>/Cast' */
  uint8_T Cast1_ig;                    /* '<S174>/Cast1' */
  uint8_T DataStoreRead2_n;            /* '<S105>/Data Store Read2' */
  uint8_T Add_h;                       /* '<S150>/Add' */
  uint8_T Cast_c;                      /* '<S151>/Cast' */
  uint8_T Cast1_ib;                    /* '<S151>/Cast1' */
  uint8_T Cast_k;                      /* '<S152>/Cast' */
  uint8_T Cast1_i0;                    /* '<S152>/Cast1' */
  ...
  rtB_BitShift6 BitShift6_a5;          /* '<S315>/Bit Shift6' */
  ...
  rtB_BitShift_c BitShift_hr;          /* '<S292>/Bit Shift' */
  ...
  rtB_BitShift3 BitShift3_dg;          /* '<S243>/Bit Shift3' */
  ...
  rtB_BitShift BitShift_pe;            /* '<S241>/Bit Shift' */
  rtB_BitShift BitShift_e3;            /* '<S240>/Bit Shift' */
  ...
  rtB_BitShift_c BitShift_ph;          /* '<S174>/Bit Shift' */
  rtB_BitShift_c BitShift_e;           /* '<S173>/Bit Shift' */
  rtB_BitShift6_b BitShift6_a;         /* '<S172>/Bit Shift6' */
  rtB_BitShift5_e BitShift5_j;         /* '<S172>/Bit Shift5' */
  rtB_BitShift4_g BitShift4_k;         /* '<S172>/Bit Shift4' */
  rtB_BitShift3_g BitShift3_d;         /* '<S172>/Bit Shift3' */
  rtB_BitShift2_e BitShift2_h;         /* '<S172>/Bit Shift2' */
  rtB_BitShift1_j BitShift1_k;         /* '<S172>/Bit Shift1' */
  rtB_BitShift_o BitShift_p;           /* '<S172>/Bit Shift' */
...
typedef struct {
  ...
  const uint8_T Cast_e;                /* '<S172>/Cast' */
  const uint8_T Cast2_f;               /* '<S172>/Cast2' */
  const uint8_T Cast3_kx;              /* '<S172>/Cast3' */
  const uint8_T Cast4_d;               /* '<S172>/Cast4' */
  const uint8_T Cast5_a;               /* '<S172>/Cast5' */
  const uint8_T Cast6_a;               /* '<S172>/Cast6' */
  const uint8_T Cast_a;                /* '<S150>/Cast' */
  const uint8_T Cast2_p;               /* '<S150>/Cast2' */
  const uint8_T Cast3_l;               /* '<S150>/Cast3' */
  const uint8_T Cast4_f;               /* '<S150>/Cast4' */
  const uint8_T Cast5_e;               /* '<S150>/Cast5' */
  const uint8_T Cast6_iq;              /* '<S150>/Cast6' */
  const boolean_T Cast1;               /* '<S78>/Cast1' */
  const boolean_T Cast2_pq;            /* '<S78>/Cast2' */
} ConstBlockIO;
